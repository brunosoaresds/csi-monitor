...
#### 3.2 Installing/Configuring CSI Monitor GUI

##### 3.2.1 Configuring SSH keys
...
##### 3.2.2 Configuring/Opening Monitor GUI
...
**NOTE:** Chooses between the 2.4 and 5 Ghz config files. You can change the network SSID and password by changind the **ssid** and **wpa_passphrase** configurations.

### 4. Monitor GUI parameters

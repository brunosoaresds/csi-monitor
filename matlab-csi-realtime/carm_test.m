...
entries_names = [1; 1; 1; 1; 1; 5; 5; 5; 5; 5];
datasets = {'csi_data_bruno_1' 'csi_data_bruno_2' ...
    'csi_data_bruno_3' 'csi_data_bruno_4' 'csi_data_bruno_5' ...
    'csi_data_p_1' 'csi_data_p_2' ...
    'csi_data_p_3' 'csi_data_p_4' 'csi_data_p_5'};
...
for i=1:size(datasets, 2)
    ...
    event = get_event_data(dataset, 700);
    features = get_carm_features(dataset, event.slices_indexes(2,:), 700);
    all_features(i,:) = features;
end

testsets = {'csi_data_bruno_6' 'csi_data_bruno_7' ...
    'csi_data_bruno_8' 'csi_data_bruno_9' 'csi_data_bruno_10' ...
    'csi_data_p_6' 'csi_data_p_7' 'csi_data_p_8' ...
    'csi_data_p_9'};
...
for i=1:size(testsets, 2)
    ...
    event = get_event_data(testset, 700);
    features = get_carm_features(testset, event.slices_indexes(2,:), 700);
